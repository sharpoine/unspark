...
@section('content')
    <!-- banner -->
    <section id="anasayfa" class="banner bg-cover position-relative d-flex justify-content-center align-items-center"
        data-background="{{ asset('frontDist/images/banner/banner2.jpg') }}">
        <div class="container">
            <div class="row">
    ...
    <!-- service -->
    <section id="hizmetlerimiz" class="section">
        <div class="container">
            <div class="row">
    ...
    <!-- feature -->
    <section id="hizmetlerimiz" class="section bg-secondary position-relative">
    ...
    <!-- about -->
    <section id="hakkimizda" class="section-lg position-relative bg-cover"
        data-background="{{ asset('frontDist/images/backgrounds/about-bg.jpg') }}">
        <img src="{{ asset('frontDist/images/backgrounds/about-bg-overlay.png') }}" alt="overlay"

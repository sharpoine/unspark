...
<!-- about -->
<section class="section-lg position-relative bg-cover" data-background="{{asset('frontDist/images/backgrounds/about-bg.jpg')}}">
  <img src="{{asset('frontDist/images/backgrounds/about-bg-overlay.png')}}" alt="overlay" class="overlay-image img-fluid">
  <div class="container">
